package br.com.winter.config.kafka;
...
import static br.com.winter.core.enums.ETopics.*;
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> producerFactory() {
        return new DefaultKafkaProducerFactory<>(productProps());
    }

    private Map<String, Object> productProps() {
        var props = new HashMap<String, Object>();
